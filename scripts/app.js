...
function navigationtabsInIt(listItems, listItemActiveClass, contentItemShowClass) {
    ...
    listItems.forEach(listItem => {
        listItem.addEventListener('click', function () {
            ...
            this.classList.toggle(listItemActiveClass)
...
navigationtabsInIt(listItem, 'resume-list__item--active', 'resume-content--show')
navigationtabsInIt(portfolioNavigation, 'portfolio-menu__item--active', 'portfolio-content--show')

// write a array with 5 objects
